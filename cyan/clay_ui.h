...
bool clay_ui_init(
    ...
    void* measureTextUserData, int width, int height
);
...
Clay_RenderCommandArray clay_app_handler_catalogue(
    CyanData* data, AppHandler* app_handler, int width, int height, bool show_debug
);
...
Clay_RenderCommandArray clay_app_handler_app(
    CyanData* data, AppHandler* app_handler, int width, int height, bool show_debug,
    bool show_header
);
...
void widget_battery(
    CyanData* data, int debugOpacity, Clay_Sizing sizing, Clay_Dimensions iconDimensions
);
